    ...
    return (
        <div className='grid gap-5 col-span-8'>
            ...
            <div className="grid gap-2.5 h-fit">
                <h2 className="text-2xl md:text-3xl font-bold w-full flex gap-4 h-fit">{loading ? <Skeleton count={2} containerClassName="w-full" baseColor="#616161" className="opacity-50" /> : selectedPost.title} 
